...
map({ "n", "v" }, "<leader>by", 'mqgg"+yG`q<cmd>delm q<cr>', { desc = "Yank to reg + (buf)" })
...
map("x", "<leader>p", '"_dP', { desc = "Paste to reg _" })
map({ "n", "v" }, "<leader>d", '"_d', { desc = "Delete to reg _" })
map({ "n", "v" }, "<leader>y", '"+y', { desc = "Yank to reg +" })
